                ...
                <div class="ranking-wrap">
                    ...
                    <table>
                        ...
                        <tr class="else-ranking">
                            ...
                            <td><strong>${rankList[7].animalName}</strong> / ${rankList[7].animalCategoryNm}</td>
                            <td><span>${rankList[7].totalP}</span>point</td>
                        </tr>
                        <tr class="else-ranking">
                            <td>${rankList[8].rank} 위!</td>
                            <td><strong>${rankList[8].animalName}</strong> / ${rankList[8].animalCategoryNm}</td>
                            <td><span>${rankList[8].totalP}</span>point</td>
                        </tr>
                        <tr class="else-ranking">
                            <td>${rankList[9].rank} 위!</td>
                            <td><strong>${rankList[9].animalName}</strong> / ${rankList[9].animalCategoryNm}</td>
